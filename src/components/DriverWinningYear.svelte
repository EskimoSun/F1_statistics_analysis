<script>
    ...
    const win_stats = [
        { points: 'Points Count', ham: 2394, sch: 810 },
        { wins: 'Wins Count', ham: 68, sch: 65 },
        { fl: 'Fastest Laps Count', ham: 38, sch: 43 },
        { pod: 'Podiums Count', ham: 103, sch: 88 },
        { poles: 'Poles Count', ham: 62, sch: 50 }
    ];
